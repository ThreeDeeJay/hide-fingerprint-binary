...
In my case, the improvement as shown in [3C Toolbox](https://play.google.com/store/apps/details?id=ccc71.at.free&hl=en-US)'s Task Manager even when idling (no other apps running in the foreground) as was night and day, with the phone running smoothly and no more first degree burns.
